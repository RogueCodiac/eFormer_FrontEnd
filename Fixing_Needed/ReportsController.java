...
//            home = FXMLLoader.load(getClass().getResource("/view/Home.fxml"));
            inventory = FXMLLoader.load(getClass().getResource("/views/Inventory.fxml"));
            inventoryValue = FXMLLoader.load(getClass().getResource("/views/InventoryValue.fxml"));
            sales = FXMLLoader.load(getClass().getResource("/views/SalesReports.fxml"));
            bestOrWorstSellers = FXMLLoader.load(getClass().getResource("/views/BestOrWorstSales.fxml"));
